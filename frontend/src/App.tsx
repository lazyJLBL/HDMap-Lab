...
export function App() {
  ...
  function renderNearby(roads: Array<{ projection_point: [number, number]; road_id: string }>) {
  ...
  function renderMatching(matches: Array<{ projection_point: [number, number]; matched_road_id: string }>) {
